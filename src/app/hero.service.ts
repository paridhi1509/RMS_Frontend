...
export class HeroService {
  ...
  /**
   * Create a delegation record in the interviewer_delegation table.
   * Maps to: <UpdateInterviewer_delegation xmlns="http://schemas.cordys.com/RMS_DB_Metadata">
   * Only uses <new> tag. delegation_id is auto-generated by the DB sequence.
   */
  createDelegation(data: {
    ...
    return this.ajax('UpdateInterviewer_delegation', 'http://schemas.cordys.com/RMS_DB_Metadata', payload);
  }
